		...
		<table class="standings table table-striped">
			...
			if( $repeater ): ?>
				...
				<?php foreach( $repeater as $i => $row ): ?>
					<?php
						$team_name = $row['team'];
						if($row['col_1']){ $cell_1 = $row['col_1']; } else { $cell_1 = ' - '; }
						if($row['col_2']){ $cell_2 = $row['col_2']; } else { $cell_2 = ' - '; }
						if($row['col_3']){ $cell_3 = $row['col_3']; } else { $cell_3 = ' - '; }
						if($row['col_4']){ $cell_4 = $row['col_4']; } else { $cell_4 = ' - '; }
						if($row['col_5']){ $cell_5 = $row['col_5']; } else { $cell_5 = ' - '; }
						if($row['col_6']){ $cell_6 = $row['col_6']; } else { $cell_6 = ' - '; }
						if($row['col_7']){ $cell_7 = $row['col_7']; } else { $cell_7 = ' - '; }
						if($row['col_8']){ $cell_8 = $row['col_8']; } else { $cell_8 = ' - '; }
						if($row['col_9']){ $cell_9 = $row['col_9']; } else { $cell_9 = ' - '; }
						if($row['col_10']){ $cell_10 = $row['col_10']; } else { $cell_10 = ' - '; }
						if($row['col_11']){ $cell_11 = $row['col_11']; } else { $cell_11 = ' - '; }
						if($row['col_12']){ $cell_12 = $row['col_12']; } else { $cell_12 = ' - '; }
					?>
						...
						<td class="pos-col"><?php
							...
							echo $placering
						?></td>
						<td class="driver-col"><?php echo esc_html( $team_name->post_title );?></td>
